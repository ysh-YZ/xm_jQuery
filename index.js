...
//    左移动函数
    ...
    ///////////////////////////头部选项卡////////////////////////////////////
    let nav=document.querySelector(".nav_box .nav");
    console.log(nav);
    let lili=document.querySelectorAll(".nav_box .nav .lili");
    console.log(lili);
    let nav_hide=document.querySelectorAll(".nav_box .nav_hide");
    console.log(nav_hide);
    let nav_hide_in=document.querySelectorAll(".nav_box .nav_hide_in");
    nav.onmouseenter=function () {
        nav_hide[0].style.height="252px";
    }
    nav.onmouseleave=function () {
        nav_hide[0].style.height="0";
    }
    for (let i=0;i<lili.length;i++){
      lili[i].onmouseenter=function () {
            nav_hide_in[i].style.display="block";
        }
        lili[i].onmouseleave=function () {
            nav_hide_in[i].style.display="none";
        }
